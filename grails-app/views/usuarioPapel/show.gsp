								...
								<g:if test="${usuarioPapelInstance?.papel}">
									<div class="panel panel-default">
										...
										<div class="panel-body">
												...
												<g:link controller="papel" action="show" id="${usuarioPapelInstance?.papel?.id}">${usuarioPapelInstance?.papel?.encodeAsHTML()}</g:link></span>
								...
								<g:if test="${usuarioPapelInstance?.usuario}">
									<div class="panel panel-default">
										...
										<div class="panel-body">
												...
												<g:link controller="usuario" action="show" id="${usuarioPapelInstance?.usuario?.id}">${usuarioPapelInstance?.usuario?.encodeAsHTML()}</g:link></span>
