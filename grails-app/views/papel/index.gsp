		        ...
		        <div class="panel panel-primary">
		            ...
		            <div class="panel-body">
		            	<table class="table table-striped">
							<thead>
								...
								<g:each in="${papelInstanceList}" status="i" var="papelInstance">
									<tr>
										...
										<td><g:link action="show" resource="${papelInstance}">${fieldValue(bean: papelInstance, field: "authority")}</g:link></td>
									
										<td>
											<g:link class="btn btn-default" action="edit" resource="${papelInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
										</td>
										<td>
											<g:form url="[resource:papelInstance, action:'delete']" method="DELETE">
							...
							<g:paginate total="${papelInstanceCount ?: 0}" />
		            </div>
		        </div>
		    </div>
		</div>
